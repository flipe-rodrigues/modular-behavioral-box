...
**10.** Place all lock _feet_ inside their corresponding slots in all walls, and then insert all lock _handles_ such that they point inwards when locked;
...
**12.** Plug in your preferred system for interfacing with sensors and actuators. Below I'm showcasing a hybrid approach using a custom PCB (thanks to the [Hardware & Software Platform at Champalimaud Research](https://www.cf-hw.org/)) and an Arduino Mega;
